...
var Header = function Header() {
  ...
  var navlist = document.querySelector('.nav-list-left');
  var ctaitem = document.querySelector('.nav-list_item-cta');
...
var _nav = require('../_modules/nav/nav');
...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)('.sub-menu-item').on('click', function () {
    this.classList.add('link-active');
  });

  (0, _jquery2.default)('.nav-list_item-cta').on('click', function () {
    alert("hi");
  });

  var swiper1 = new _swiper2.default('.swiper-container1', {
    spaceBetween: 36,
    slidesPerView: 'auto',
    observer: true,
    observeParents: true,
  ...
  var swiper2 = new _swiper2.default('.swiper-container2', {
    spaceBetween: 36,
    slidesPerView: 'auto',
    observer: true,
    observeParents: true,
  ...
  (0, _jquery2.default)('.ga-event').on('click', function () {
    var elem = (0, _jquery2.default)(this);
    ga('send', 'event', elem.data('gacategory'), elem.data('gaactions'), elem.data('galabel'));
  });

  // Faqs page accordion
  var $item = (0, _jquery2.default)('.collapsible');
...
},{"../_modules/header/header":4,"../_modules/nav/nav":5,"jquery":1,"scrollreveal":2,"swiper":3}]},{},[6])
